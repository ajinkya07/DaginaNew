...
class RangeSlider extends React.Component {
  ...
  render() {
    ...
    let headerTheme2 = global.headerTheme
        ...
        {data ? (
          <View style={{ marginLeft: 10 }}>
            <MultiSlider
              ...
              step={1}
              selectedStyle={{
                backgroundColor: headerTheme2 ? '#' + headerTheme2 : '#19af81'
              }}
              unselectedStyle={{
...
class LengthSlider extends React.Component {
  ...
  render() {
    ...
    let headerTheme3 = global.headerTheme
        ...
        {data ? (
          <View style={{ marginLeft: 10 }}>
            <MultiSlider
              ...
              max={parseFloat(values[1])}
              step={1}
              selectedStyle={{ backgroundColor: headerTheme3 ? '#' + headerTheme3 : '#19af81' }}
              unselectedStyle={{ backgroundColor: 'silver' }}
              trackStyle={{ height: 4 }}
              markerStyle={{
                backgroundColor: headerTheme3 ? '#' + headerTheme3 : '#19af81',
                width: 26,
                height: 26,
                borderRadius: 13,
              }}
